...
async function fetchProducts() {
    try {
        ...
        const url = "".concat(API_BASE_URL, "/api/products?t=").concat(Date.now());
...
{
const e = new Error("Could not parse module '[project]/src/app/dashboard/products/page.js'\n\nParenthesized expression cannot be empty");
...
//# sourceMappingURL=_fcaff297._.js.map
 ...
 */ const fetchProductById = async (id)=>{
    try {
        ...
        if (!response.ok) {
            const errorData = await response.json().catch(()=>({}));
            throw new Error(errorData.message || "Product ".concat(id, " not found"));
        }
        return await response.json();
    } catch (error) {
        console.error("fetchProductById error for ID ".concat(id, ":"), error);
        throw error;
    }
};
/**
 ...
 */ const fetchOrders = async ()=>{
    try {
        const response = await fetch("".concat(API_BASE_URL, "/orders"), {
            headers: {
                'Authorization': "Bearer ".concat(("TURBOPACK compile-time value", "saman121213xpCrocode"))
            },
            cache: 'no-store'
        });
        if (!response.ok) {
 ...
 */ const createProduct = async (productData)=>{
    try {
        const response = await fetch("".concat(API_BASE_URL, "/admin/products"), {
            method: 'POST',
            headers: {
 ...
 */ const updateProduct = async (id, productData)=>{
    try {
        const response = await fetch("".concat(API_BASE_URL, "/admin/products/").concat(id), {
            method: 'PUT',
            headers: {
                'Content-Type': 'application/json',
                'Authorization': "Bearer ".concat(("TURBOPACK compile-time value", "saman121213xpCrocode"))
        ...
        console.error("updateProduct error for ID ".concat(id, ":"), error);
        throw error;
    }
};
/**
 ...
 */ const deleteProduct = async (id)=>{
    try {
        ...
        console.error("deleteProduct error for ID ".concat(id, ":"), error);
        throw error;
    }
};
;
...
"[project]/src/app/dashboard/products/edit/[id]/page.js [app-client] (ecmascript)": ((__turbopack_context__) => {
"use strict";

var { k: __turbopack_refresh__, m: module } = __turbopack_context__;
{
//app/dashboard/products/edit/[id]/page.js
__turbopack_context__.s({
...
function EditProductPage(param) {
            ...
            const loadProduct = {
                "EditProductPage.useEffect.loadProduct": async ()=>{
                    try {
                        ...
                        const data = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$api$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["fetchProductById"])(id);
                        setProduct(data);
                    } catch (err) {
    ...
    const handleSubmit = async (e)=>{
        ...
        try {
            ...
            await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$api$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["updateProduct"])(id, {
                ...formData,
            ...
            alert('خطا در ویرایش محصول: ' + err.message);
        }
    };
...
_s(EditProductPage, "/lZlanm7Fr2h1G8k06Tw2SY87LQ=", false, function() {
    return [
...
//# sourceMappingURL=_b6cae69a._.js.map
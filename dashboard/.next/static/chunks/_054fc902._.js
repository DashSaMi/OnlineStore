...
async function makeRequest(endpoint) {
    ...
    if (__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$build$2f$polyfills$2f$process$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].env.ADMIN_SECRET) {
        headers['Authorization'] = "Bearer ".concat(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$build$2f$polyfills$2f$process$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].env.ADMIN_SECRET);
    }
    const config = {
        method,
        headers,
...
async function createProduct(productData) {
    const response = await fetch('/api/products', {
        ...
        headers: {
            'Content-Type': 'application/json',
            'Authorization': "Bearer ".concat(await getSessionToken()) // Implement your token retrieval
        },
...
//# sourceMappingURL=_054fc902._.js.map
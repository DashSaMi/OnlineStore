...
async function EditProductPage({ params }) {
    const product = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$api$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["fetchProductById"])(params.id);
    return `
    <div class="p-4">
      <h1 class="text-2xl font-bold mb-6">ویرایش محصول</h1>
      
      <form id="editForm" class="bg-white p-6 rounded-lg shadow">
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
          ...
          <div class="md:col-span-2">
            ...
            <input
              ...
              required
            />
            <img src="${product.imageUrl}" alt="Preview" class="mt-2 h-32 object-contain" />
          </div>
        </div>
...
//# sourceMappingURL=%5Broot-of-the-server%5D__6e91e4df._.js.map
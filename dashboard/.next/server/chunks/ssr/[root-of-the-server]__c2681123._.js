...
"[project]/src/app/dashboard/products/edit/[id]/components/EditProductForm.js [app-ssr] (ecmascript)": ((__turbopack_context__) => {
"use strict";
...
;
;
function EditProductForm({ params }) {
    const { id } = params;
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useEffect"])(()=>{
        async function loadProduct() {
            setLoading(true);
            try {
                const product = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$api$2f$products$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["getProduct"])(id);
                setFormData({
                    name: product.name || '',
    ...
    const handleSubmit = async (e)=>{
        ...
        try {
            ...
            await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$api$2f$products$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["updateProduct"])(productData);
            router.push('/dashboard/products');
        } catch (e) {
            setError(e.message || 'خطا در بروزرسانی محصول');
        } finally{
            setLoading(false);
        }
    };
    if (loading && !formData.name) return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("p", {
        children: "در حال بارگذاری..."
    }, void 0, false, {
        fileName: "[project]/src/app/dashboard/products/edit/[id]/components/EditProductForm.js",
        lineNumber: 81,
        columnNumber: 41
    }, this);
...
//# sourceMappingURL=%5Broot-of-the-server%5D__c2681123._.js.map